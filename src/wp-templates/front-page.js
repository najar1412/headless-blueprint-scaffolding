...
export default function Component(props) {
  ...
  const [showSite, _] = useState(false);
  ...
  return (
    <>
      ...
      >
        <Image alt="nexus logo" width={"280rem"} src={logo} />
      </div>
          ...
          >
            ...
            <Section label="services" bgColor="var(--mantine-color-brand-1)">
              <Stack px={{ base: "0rem" }}>
                ...
                <Grid
                  visibleFrom="lg"
                  className={styles["service-grid-desktop"]}
                >
                  {page.s2.serviceCards.map((card) => (
                    <Grid.Col span={{ base: 12, md: 4 }}>
                      <ServicesCard
            ...
            >
                  ...
                  >
                    ...
                    <Grid.Col span={{ base: 12, md: 6 }}>
                      <Stack>
                        ...
                        >
                          Joining with market access leaders, we sought to bring
                          together a curated group of people to meet the needs
                          of the evolving market access landscape.
                        </Text>
                      </Stack>
                    </Grid.Col>
                  </Grid>
              ...
              >
                <PinnedSection
                  background={page.s1.background.node.mediaItemUrl}
                />
              </Container>
            </Container>
